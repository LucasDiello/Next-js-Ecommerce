...
export default function Page() {
  ...
  return (
    <div className="max-w-4xl flex items-center h-auto lg:h-screen my-10 flex-wrap mx-auto lg:my-0">
      <div
        id="profile"
        className="w-full lg:w-3/5 mt-28 rounded-lg lg:rounded-l-lg lg:rounded-r-none shadow-2xl bg-white opacity-75 mx-6 lg:mx-0"
      >

    ...
    <AppTheme {...props}>
      ...
      <Grid container direction="row" component="main" sx={{ height: '100vh' }}>
        ...
        <Grid
          ...
          md={5}
          sx={{
            backgroundImage: 'url(https://img.freepik.com/fotos-gratis/guarda-roupa-digital-em-tela-transparente_53876-105380.jpg?t=st=1727376242~exp=1727379842~hmac=63d216194eaaa3ad3e0ab0c46d2f04a35be5419404fe48e21087704edcb87297&w=1800)',

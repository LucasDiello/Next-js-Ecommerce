...
import card1Top from "@/images/1480.png";
    ...
    <section className="h-[100vh] flex flex-col">
        ...
        <div className="main-card w-[100%] md:w-[50%] h-[400px] md:rounded-xl">
          <div>
            ...
            <div className="absolute top-20 md:top-36 md:ml-10 ml-4 space-y-5 flex flex-col justify-center  ">
              <h2 className="text-white uppercase text-xs tracking-wide max-w-[90%] w-full">
                Unique promotions, don&apos;t miss out
              </h2>
              <div className="flex flex-col space-y-2">
                ...
                <p className="text-[10px] tracking-wider">
                  <span className="line-through ">R$2499.99</span> from
                  R$2299.99 or <br />4 payments of R$574.99
                </p>
              </div>
              <button
                onClick={scrollToNextSection}
                className="bg-[rgb(31,41,55)] h-10 rounded-xl cursor-pointer  text-xs border-none text-white w-36"
              >
                Buy Now
              </button>
            </div>
          ...
          <div className="card-top flex space-x-5 ">
            <div className="card-top1 h-[190px] w-[50%] bg-[rgb(200,223,255)] rounded-xl">
              ...
              <div className="absolute rotate top-44  space-y-5 flex flex-col justify-center  ">
                <div className="flex flex-col space-y-2 ">
                  ...
                  <p className="text-[10px] tracking-wider">
                    <span className="line-through ">R$1499.99</span> from
                    R$1299.99 or <br />4 payments of R$324.99
                  </p>
                </div>
              </div>
            </div>
            <div className="h-[190px] w-[50%] bg-[rgb(200,223,255)] rounded-xl flex justify-end">
              <Image
                src={card1Top}
                alt="Card 1"
                className="card-top2-img object-cover h-full w-full"
              />
          ...
          <div className="flex space-x-5">
            <div className="card-bottom1  h-[190px] w-[50%] rounded-xl">
              <Image
                src={card1Bottom}
                alt="Card 1"
                className="object-cover relative  h-full w-full rounded-xl"
              />
              <div className="absolute top-96  text-white font-bold  space-y-5 flex flex-col justify-center  ">
                <div className="flex flex-col space-y-2  relative left-[6.5rem] bottom-8">
                  <h1 className="text-xl font-bold  ">Headphones</h1>
                  <p className="text-[6px] tracking-wider text-end">
                    <span className="line-through ">$499.99</span> from $299.99
                    or <br />4 payments of $74.99
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="absolute top-96  text-white font-bold flex flex-col justify-center  ">
                <div className="flex flex-col relative left-36 bottom-8">
                  ...
                  <div className="w-full flex justify-end mt-2">
                    <button
                      onClick={scrollToNextSection}
                      className="bg-[rgb(31,41,55)] rounded-xl cursor-pointer  text-[10px] border-none text-white w-14 h-5
                "
                    >
                      Buy
                    </button>
      ...
      <div className="marcas mt-20">
        <div className="flex justify-center items-center space-x-5">
          <div
            onClick={scrollToNextSection}
            className="cursor-pointer airpods1 h-[100px] w-[100px]  rounded-full"
          >
            <Image
              src={card1Bottom}
              alt="Card 1"
              className="object-cover relative  h-full w-full rounded-full"
            />
          </div>
          <div
            onClick={scrollToNextSection}
            className="cursor-pointer airpods2 h-[100px] w-[100px]  rounded-full"
          >
            <Image
              src={card2Bottom}
              alt="Card 1"
